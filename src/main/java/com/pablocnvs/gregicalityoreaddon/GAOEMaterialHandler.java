...
public class GAOEMaterialHandler implements IMaterialHandler {
    ...
    public static final SimpleDustMaterial PalladiumAluminaCatalyst = new SimpleDustMaterial("palladium_alumina_catalyst",(Palladium.materialRGB+Alumina.rgb)/2, (short) 2001, MaterialIconSet.SHINY, "(Pd)Al2O3");

    //Amblygonite

    public static final SimpleDustMaterial MajorAmblygoniteResidue = new SimpleDustMaterial("major_amblygonite_residue",(AluminiumHydroxide.rgb+DisodiumPhosphate.rgb)/2,(short) 2002,MaterialIconSet.ROUGH);
    public static final SimpleDustMaterial MinorAmblygoniteResidue = new SimpleDustMaterial("minor_amblygonite_residue",(BandedIron.materialRGB+Pyrolusite.materialRGB)/2,(short) 2003,MaterialIconSet.ROUGH);
    ...
    public static final SimpleDustMaterial PbCuBiOxidesMix = new SimpleDustMaterial("pb_cu_bi_oxides_mix",(Massicot.materialRGB+Cuprite.materialRGB+Bismite.materialRGB)/3,(short) 2004,MaterialIconSet.ROUGH,"PbCuBiO3");
    public static final SimpleDustMaterial WellMixedPbBiOxides = new SimpleDustMaterial("well_mixed_pb_bi_oxides",(Massicot.materialRGB+Bismite.materialRGB)/2,(short) 2005,MaterialIconSet.DULL,"Pb2Bi2O5");
    public static final SimpleDustMaterial CalciumPlumbide = new SimpleDustMaterial("calcium_plumbide",(Lead.materialRGB+CalciumCarbide.rgb/2),(short) 2006, MaterialIconSet.SHINY,"Ca2Pb");
    public static final SimpleDustMaterial CalciumBismuthAlloy = new SimpleDustMaterial("calcium_bismuth_alloy",(Calcium.materialRGB+Bismuth.materialRGB),(short) 2007,MaterialIconSet.METALLIC,"CaBi");
    ...
    public static final SimpleDustMaterial BerylliumAluminiumSulfate = new SimpleDustMaterial("beryllium_aluminium_sulfate",(BerylliumFluoride.materialRGB+AluminiumSulfate.rgb)/2,(short) 2008,MaterialIconSet.ROUGH,"Be3Al2(SO4)6");
    public static final SimpleDustMaterial AmmoniumAlum = new SimpleDustMaterial("ammonium_alum",(AmmoniumSulfate.rgb+AluminiumSulfate.rgb)/2,(short) 2009,MaterialIconSet.DULL,"NH4Al(SO4)2");
    public static final SimpleDustMaterial SodiumFluorosilicate = new SimpleDustMaterial("sodium_fluorosilicate",FluorosilicicAcid.rgb,(short) 2010,MaterialIconSet.ROUGH,"Na2SiF6");
    public static final SimpleDustMaterial BerylliumHydroxide = new SimpleDustMaterial("beryllium_hydroxide",BerylliumFluoride.materialRGB,(short) 2011,MaterialIconSet.DULL,"Be(OH)2");
    ...
    public static final SimpleDustMaterial RoastedCarnotite = new SimpleDustMaterial("roasted_carnotite",Carnotite.materialRGB+SodiumNitrate.materialRGB-SodiumOxide.rgb,(short) 2012,MaterialIconSet.ROUGH);

    //Nickeline

    public static final SimpleDustMaterial NickelRareResidue = new SimpleDustMaterial("nickel_rare_residiue",(PlatinumMetallicPowder.materialRGB+Nickeline.materialRGB)/2,(short) 2013,MaterialIconSet.DULL);
    public static final SimpleDustMaterial NickelSulfatePrecipitate = new SimpleDustMaterial("nickel_sulfate_precipitate",Nickeline.materialRGB/3+Pentlandite.materialRGB*2/3,(short) 2014,MaterialIconSet.ROUGH);
    public static final SimpleDustMaterial CopperFreeNickelSulfate = new SimpleDustMaterial("copper_free_nickel_sulfate",NickelSulfatePrecipitate.rgb,(short) 2015,MaterialIconSet.ROUGH);
    public static final SimpleDustMaterial NickelSulfide = new SimpleDustMaterial("nickel_sulfide",Pentlandite.materialRGB,(short) 2016,MaterialIconSet.ROUGH,"NiS");
    public static final SimpleDustMaterial CobaltSulfide = new SimpleDustMaterial("cobalt_sulfide",Cobalt.materialRGB,(short) 2017,MaterialIconSet.ROUGH,"CoS");
    ...
    public static final SimpleDustMaterial CuSnFeOxidesMixture = new SimpleDustMaterial("cu_sn_fe_oxides_mix",(BandedIron.materialRGB+Cassiterite.materialRGB+CupricOxide.rgb)/3,(short) 2018,MaterialIconSet.DULL);
    public static final SimpleDustMaterial TinCopperMix = new SimpleDustMaterial("tin_copper_mix",(Tin.materialRGB+Copper.materialRGB)/2,(short) 2019,MaterialIconSet.ROUGH);
    public static final SimpleDustMaterial ImpureTinDust = new SimpleDustMaterial("impure_tin_dust",Tin.materialRGB*5/6,(short) 2020, MaterialIconSet.METALLIC,"Sn3Bi");
    public static final SimpleDustMaterial IronSilicateResidue = new SimpleDustMaterial("iron_silicate_residue",(Ferrosilite.materialRGB+ArsenicTrioxide.materialRGB+AntimonyTrioxide.materialRGB),(short) 2021,MaterialIconSet.ROUGH);

    //Sylvanite

    public static final SimpleDustMaterial GoldTelluride = new SimpleDustMaterial("gold_telluride",0xc9c290,(short) 2022,MaterialIconSet.SHINY);
    ...
    public static final SimpleDustMaterial ThoriumSulfate = new SimpleDustMaterial("thorium_sulfate",Thorium.materialRGB,(short) 2023,MaterialIconSet.ROUGH,"Th(SO4)2");
    public static final SimpleDustMaterial ThoriumFluoride = new SimpleDustMaterial("thorium_fluoride",Thorium.materialRGB,(short) 2024,MaterialIconSet.ROUGH,"ThF4");
    ...
    public static final SimpleDustMaterial RoastedRheniite = new SimpleDustMaterial("roasted_rheniite",(Quicklime.materialRGB+Rheniite.materialRGB+ BariumOxide.rgb)/3,(short) 2025,MaterialIconSet.ROUGH);
    public static final SimpleDustMaterial REEFilteredRheniiteResiudalOxides = new SimpleDustMaterial("ree_filtered_rheniite_residual_oxides",(CubicZirconia.materialRGB+HafniumOxide.rgb+NiobiumTantalumOxide.rgb+RarestMetalResidue.materialRGB)/4,(short) 2026,MaterialIconSet.ROUGH);
    public static final SimpleDustMaterial RheniiteResidualOxides = new SimpleDustMaterial("rheniite_residual_oxides",(REEFilteredRheniiteResiudalOxides.rgb+RareEarth.materialRGB)/2,(short) 2027,MaterialIconSet.SHINY);
    public static final SimpleDustMaterial Leucine = new SimpleDustMaterial("leucine", 0x356a1b,(short) 2028, MaterialIconSet.DULL, "C6H13NO2");
    ...
    public static final SimpleDustMaterial SodiumZirconate = new SimpleDustMaterial("sodium_zirconate",(SodiumOxide.rgb+CubicZirconia.materialRGB)/2,(short) 2029,MaterialIconSet.ROUGH,"Na2ZrO3");
    public static final SimpleDustMaterial ZirconiumHydrogenphosphate = new SimpleDustMaterial("zirconium_hydrogenphosphate",(Zirconium.materialRGB+PhosphoricAcid.materialRGB),(short) 2030,MaterialIconSet.DULL,"Zr(HPO4)2");
    ...
    public static final SimpleDustMaterial LeadSulfate = new SimpleDustMaterial("lead_sulfate",(Massicot.materialRGB+Sulfur.materialRGB)/2,(short) 2031, MaterialIconSet.ROUGH, "PbSO4");
    public static final SimpleDustMaterial CopperSulfide = new SimpleDustMaterial("copper_sulfide", 0x212360,(short) 2032, MaterialIconSet.ROUGH, "CuS");

    //Carrolite

    public static final SimpleDustMaterial RoastedCarrolite = new SimpleDustMaterial("roasted_carrolite", Carrolite.materialRGB*5/7, (short) 2033, MaterialIconSet.ROUGH);
    public static final SimpleFluidMaterial CarroliteSulfuricSolution = new SimpleFluidMaterial("carrolite_sulfuric_solution", (RoastedCarrolite.rgb+SulfuricAcid.materialRGB)/2);
    public static final SimpleFluidMaterial ImpureCobaltSulfateSolution = new SimpleFluidMaterial("impure_cobalt_sulfate_solution", (Cobaltite.materialRGB+CobaltOxide.materialRGB+SulfuricAcid.materialRGB)/3);
    public static final SimpleDustMaterial CobaltOxideHydroxide = new SimpleDustMaterial("cobalt_oxide_hydroxide",(LithiumCobaltOxide.rgb+CobaltOxide.materialRGB)/2,(short) 2034, MaterialIconSet.ROUGH, "CoOOH");
    public static final SimpleDustMaterial SodiumHydrosulfide = new SimpleDustMaterial("sodium_hydrosulfide",(HydrogenSulfide.materialRGB+SodiumHydroxide.materialRGB*2)/3,(short) 2035, MaterialIconSet.DULL, "NaHS");
